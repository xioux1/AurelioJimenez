...
def test_pipeline_main_returns_expected_columns():
    ...
    with patch('pipeline.load_data', return_value=(train_df, test_df, sample_submission_df, test_ids_df)), \
         ...
         patch('pipeline.clean_features', side_effect=lambda X, X_test, low_var_thresh, corr_thresh=0.95: (X, X_test, {})), \
        ...
        def dummy_train_model(X, y, X_test, ranker_ids, cat_features, *, params, n_folds=5):
